...
# Java Data Structures Bootstrap Setup
#
...
Write-Host ""
Write-Host "Java Data Structures Bootstrap Setup" -ForegroundColor Cyan
...
Write-Host "  1. See the program catalog:               just list" -ForegroundColor Gray
Write-Host "  2. Compile everything:                    just build-all" -ForegroundColor Gray
Write-Host "  3. Run one program (sample input):        just run Proto8" -ForegroundColor Gray
Write-Host "  4. Run one with your own typed input:     just run-interactive Proto8" -ForegroundColor Gray
